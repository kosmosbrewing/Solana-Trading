...
> Historical snapshots: [`docs/exec-plans/completed/measurement-snapshots.md`](./docs/exec-plans/completed/measurement-snapshots.md)
...
- 이 문서는 점수 체계와 판정 규칙만 유지한다.
- 특정 날짜의 운영 스냅샷이나 당시 상태 해석은 현재 기준 문서가 아니다.
- historical measurement snapshot이 필요하면 [`docs/exec-plans/completed/measurement-snapshots.md`](./docs/exec-plans/completed/measurement-snapshots.md)를 참고한다.
