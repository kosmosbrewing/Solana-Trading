...
> 2026-04-14: bootstrap_10s **signal-only** (executionRrReject=99.0, volSurge=**1.8**, buyRatio=**0.60**) + **Cupsey Lane primary** (Gate: trade_count≥1.0으로 완화 + CUSUM observation-only, 0.01 SOL, 50-trade edge 검증 중). VPS 검증 baseline으로 복귀. Strategy A/C dormant, D sandbox only.
