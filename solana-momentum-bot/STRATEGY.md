...
- 19-token 크로스밸리데이션 스윕에서 TP2=5.0이 상위 15개 조합 전부에서 최적으로 수렴했다.
- SL 1.25 ATR은 1.0보다 약간의 호흡 공간을 주면서 MAE 기준 안정적이다.
- effectiveRR = 5.0/1.25 = 4.0 → RR gate(1.2/1.5) 통과.
...
TP2=5x ATR 기준이므로 RR 평가도 TP2 기준으로 해야 한다.
