...
5-session replay sweep 기준 현재 안정형 baseline은 `1.8 / 0.60 / 20`이다.
...
| `REALTIME_VOLUME_SURGE_MULTIPLIER` | `1.8` | 4/4 replay stable baseline |
| `REALTIME_VOLUME_SURGE_LOOKBACK` | `20` | lookback 30보다 우세 |
| `REALTIME_BOOTSTRAP_MIN_BUY_RATIO` | `0.60` | bootstrap 전용 soft filter |
