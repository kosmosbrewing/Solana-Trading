...
- **v5 "수익은 길게, 손실은 짧게" + follow-up parity fix 완료** — realtime gate / backtest / scanner blacklist 정렬 (2026-03-31)
...
**다음 조치:**
1. v5 기준 backtest 재검증 (P0)
2. paper canary `20~50`건으로 gate/runner 구조 확인 (P0)
3. live canary는 paper 통과 후 전환 (P1)
4. live는 필요 시 runtime sanity / telemetry shape 확인 용도로만 선행
...
> **지금 할 일: v5 backtest 재검증 → paper canary 20~50건 → live canary → 50 trades 기준으로 Phase 2 판단.**
