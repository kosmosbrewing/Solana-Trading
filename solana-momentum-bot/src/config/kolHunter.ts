...
export const kolHunter = {
  ...
  kolHunterRotationUnderfillMinDiscountPct: numEnv('KOL_HUNTER_ROTATION_UNDERFILL_MIN_DISCOUNT_PCT', '0.02'),
  kolHunterRotationUnderfillMaxDiscountPct: numEnv('KOL_HUNTER_ROTATION_UNDERFILL_MAX_DISCOUNT_PCT', '0.12'),
  kolHunterRotationUnderfillT1Mfe: numEnv('KOL_HUNTER_ROTATION_UNDERFILL_T1_MFE', '0.05'),
  kolHunterRotationUnderfillT1TrailPct: numEnv('KOL_HUNTER_ROTATION_UNDERFILL_T1_TRAIL_PCT', '0.025'),
