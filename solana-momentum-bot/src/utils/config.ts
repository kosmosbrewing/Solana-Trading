...
export const config = {
  ...
  realtimePoolDiscoveryRequestSpacingMs: numOptional('REALTIME_POOL_DISCOVERY_REQUEST_SPACING_MS', 150),
  realtimePoolDiscoveryQueueLimit: numOptional('REALTIME_POOL_DISCOVERY_QUEUE_LIMIT', 500),
