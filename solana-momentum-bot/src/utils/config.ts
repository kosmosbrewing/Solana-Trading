...
export const config = {
  ...
  defaultAmmFeePct: numOptional('DEFAULT_AMM_FEE_PCT', 0.003),
  ...
  realtimePoolDiscoveryConcurrency: numOptional('REALTIME_POOL_DISCOVERY_CONCURRENCY', 2),
  realtimePoolDiscoveryRequestSpacingMs: numOptional('REALTIME_POOL_DISCOVERY_REQUEST_SPACING_MS', 250),
  realtimePoolDiscoveryQueueLimit: numOptional('REALTIME_POOL_DISCOVERY_QUEUE_LIMIT', 250),
  ...
  /** TP2 배수 (ATR × N). v5 runner-centric 10.0 (sweep 최적 5.0에서 확장). live path는 REALTIME 참조. */
  tp2Multiplier: numOptional('TP2_MULTIPLIER', 10.0),
  /** SL ATR 배수 (entry - ATR × N). v5 default 1.0. live path는 REALTIME_SL_ATR_MULTIPLIER(1.5) 사용. */
