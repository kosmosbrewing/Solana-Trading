...
import {
  ...
  hydrateRotationLiveKolDecayFromCloseRecords,
...
jest.mock('../src/utils/config', () => ({
  config: {
    ...
    kolHunterRotationChaseTopupLiveCanaryEnabled: false,
    ...
    kolHunterRotationMaeFastFailEnabled: true,
    kolHunterRotationMaeFastFailMinElapsedSec: 3,
    kolHunterRotationMaeFastFailMaxMaePct: 0.02,
    kolHunterRotationMaeFastFailMaxMfePct: 0.015,
    ...
    kolHunterRotationUnderfillDoaWindowSec: 10,
    ...
    kolHunterRotationLiveKolDecayMinCloses: 2,
    kolHunterRotationLiveKolDecayLossRatio: 1,
    kolHunterRotationLiveKolDecayCooldownMs: 7_200_000,
    kolHunterCapitulationReboundEnabled: false,
    kolHunterCapitulationReboundPaperEnabled: true,
    kolHunterCapitulationReboundParameterVersion: 'capitulation-rebound-v1.0.0',
    kolHunterCapitulationReboundMinKolScore: 4.5,
    kolHunterCapitulationReboundMinDrawdownPct: 0.35,
    kolHunterCapitulationReboundMaxDrawdownPct: 0.65,
    kolHunterCapitulationReboundMinBouncePct: 0.06,
    kolHunterCapitulationReboundRecoveryConfirmations: 2,
    kolHunterCapitulationReboundRecoverySpacingSec: 0,
    kolHunterCapitulationReboundMaxRecentSellSol: 0,
    kolHunterCapitulationReboundMaxRecentSellKols: 0,
    kolHunterCapitulationReboundT1Mfe: 0.08,
    kolHunterCapitulationReboundT1TrailPct: 0.05,
    kolHunterCapitulationReboundProfitFloorMult: 1.03,
    kolHunterCapitulationReboundNoReactionSec: 15,
    ...
    kolHunterSmartV3LiveBlockExitLiquidityUnknown: false,
    kolHunterSmartV3LiveBlockTokenQualityUnknown: false,
    kolHunterSmartV3LiveBlockUncleanToken: true,
    kolHunterSmartV3PreEntrySellLiveBlockEnabled: true,
    kolHunterSmartV3PreEntrySellMinNoSellSec: 60,
    kolHunterSmartV3ComboDecayEnabled: true,
    kolHunterSmartV3ComboDecayCooldownMs: 21_600_000,
    kolHunterSmartV3ComboDecayMinCloses: 2,
    kolHunterSmartV3ComboDecayLossRatio: 1.0,
    kolHunterSmartV3KolFillAdvantageEnabled: true,
    kolHunterSmartV3MaxAdverseKolFillPct: 0.03,
    ...
    kolHunterSmartV3MaeFastFailEnabled: true,
    kolHunterSmartV3MaeFastFailMinElapsedSec: 5,
    kolHunterSmartV3MaeFastFailMaxMfePct: 0.03,
    kolHunterSmartV3MaeFastFailMaxMaePct: 0.06,
    kolHunterSmartV3MaeFastFailFreshBuyGraceSec: 15,
    kolHunterSmartV3MaeRecoveryHoldEnabled: true,
...
describe('kolSignalHandler — state machine', () => {
  ...
  beforeEach(() => {
    ...
    mockedConfig.kolHunterSmartV3LiveStrictQualityEnabled = true;
    mockedConfig.kolHunterSmartV3LiveBlockExitLiquidityUnknown = false;
    mockedConfig.kolHunterSmartV3LiveBlockTokenQualityUnknown = false;
    ...
    mockedConfig.kolHunterSmartV3ComboDecayLossRatio = 1.0;
    mockedConfig.kolHunterSmartV3KolFillAdvantageEnabled = true;
    mockedConfig.kolHunterSmartV3MaxAdverseKolFillPct = 0.03;
    ...
    mockedConfig.kolHunterRotationMaeFastFailEnabled = true;
    ...
    mockedConfig.kolHunterRotationUnderfillDoaWindowSec = 10;
    ...
    mockedConfig.kolHunterRotationLiveKolDecayMinCloses = 2;
    mockedConfig.kolHunterRotationLiveKolDecayLossRatio = 1;
    mockedConfig.kolHunterRotationLiveKolDecayCooldownMs = 7_200_000;
    mockedConfig.kolHunterCapitulationReboundEnabled = false;
    mockedConfig.kolHunterCapitulationReboundPaperEnabled = true;
    mockedConfig.kolHunterCapitulationReboundParameterVersion = 'capitulation-rebound-v1.0.0';
    mockedConfig.kolHunterCapitulationReboundMinKolScore = 4.5;
    mockedConfig.kolHunterCapitulationReboundMinDrawdownPct = 0.35;
    mockedConfig.kolHunterCapitulationReboundMaxDrawdownPct = 0.65;
    mockedConfig.kolHunterCapitulationReboundMinBouncePct = 0.06;
    mockedConfig.kolHunterCapitulationReboundRecoveryConfirmations = 2;
    mockedConfig.kolHunterCapitulationReboundRecoverySpacingSec = 0;
    mockedConfig.kolHunterCapitulationReboundMaxRecentSellSol = 0;
    mockedConfig.kolHunterCapitulationReboundMaxRecentSellKols = 0;
    mockedConfig.kolHunterCapitulationReboundT1Mfe = 0.08;
    mockedConfig.kolHunterCapitulationReboundT1TrailPct = 0.05;
    mockedConfig.kolHunterCapitulationReboundProfitFloorMult = 1.03;
    mockedConfig.kolHunterCapitulationReboundNoReactionSec = 15;
    ...
    mockedConfig.kolHunterSmartV3MaeFastFailMaxMaePct = 0.06;
    mockedConfig.kolHunterSmartV3MaeFastFailFreshBuyGraceSec = 15;
    mockedConfig.kolHunterSmartV3MaeRecoveryHoldEnabled = true;
    ...
    mockedConfig.kolHunterSmartV3FastFailLiveParameterVersion = 'smart-v3-fast-fail-live-v1.0.0';
    mockedConfig.kolHunterSmartV3FastFailLiveMaxTop10HolderPct = 0.80;
    mockedConfig.kolHunterSmartV3FastFailLiveMaxAdverseKolFillPct = 0.75;
  ...
  describe('smart-v3 main logic', () => {
    ...
    it('velocity trigger 는 multi-KOL S/A 독립 합의에서 smart-v3 main 으로 진입한다', async () => {
      ...
      expect(positions[0].smartV3LiveEligibleShadow).toBe(true);
      expect(positions[0].smartV3LiveBlockReason).toBeNull();
    });
    ...
    it('smart-v3 paper arms enabled: 동일 trigger 에 fast-fail/runner-relaxed shadow arms 를 병렬 생성한다', async () => {
      ...
      expect(fastFail?.parameterVersion).toBe('smart-v3-fast-fail-v1.0.0');
    ...
    it('smart-v3 entry-filter shadow 는 실제 진입을 막지 않고 missed-alpha 로 비교군을 남긴다', async () => {
      ...
      const markers = mockAppendFile.mock.calls
        .filter((call) => typeof call[0] === 'string' && call[0].includes('missed-alpha.jsonl'))
        .map((call) => JSON.parse(String(call[1]).trim()))
        .filter((row) => row.extras?.eventType === 'smart_v3_entry_filter_shadow');
      expect(markers.map((row) => row.signalSource).sort()).toEqual([
        'smart_v3_live_eligible_only_shadow',
        'smart_v3_velocity_only_shadow',
      ]);
      expect(markers[0].extras.entryReason).toBe('pullback');
      expect(markers[0].extras.smartV3LiveEligibleShadow).toBe(false);
    });
    ...
    it('smart-v3 close ledger 는 copyable-edge shadow field 를 남긴다', async () => {
      ...
      expect(pos.smartV3LiveEligibleShadow).toBe(false);
      expect(pos.smartV3LiveBlockReason).toBe('live canary requires fresh independentKolCount >= 2');
      expect(pos.smartV3LiveBlockFlags).toContain('LIVE_MIN_KOL');
      ...
      expect(row.smartV3LiveEligibleShadow).toBe(false);
      expect(row.smartV3LiveBlockReason).toBe('live canary requires fresh independentKolCount >= 2');
      expect(row.smartV3LiveBlockFlags).toContain('LIVE_MIN_KOL');
      ...
      expect(row.extras.smartV3LiveEligibleShadow).toBe(false);
      expect(row.extras.smartV3LiveBlockReason).toBe('live canary requires fresh independentKolCount >= 2');
      ...
      expect(projectionRows[0].smartV3LiveEligibleShadow).toBe(false);
    });

    it('smart-v3: 낮은 MFE + 빠른 token-only MAE 악화는 mae fast-fail 로 닫는다', async () => {
      mockedConfig.kolHunterSmartV3FreshWindowSec = 120;
      stubFeed.setInitialPrice(MINT_SMART, 0.001);
      await handleKolSwap(buyTx('k1', 'S', MINT_SMART, 70_000));
      await handleKolSwap(buyTx('k2', 'A', MINT_SMART));
      ...
      pos!.peakPrice = pos!.marketReferencePrice;
      pos!.troughPrice = pos!.marketReferencePrice;
      mockedConfig.kolHunterSmartV3MaeFastFailMinElapsedSec = 0;
      let captured: any = null;
      kolHunterEvents.once('paper_close', (evt) => { captured = evt; });
      __testTriggerTick(pos!.positionId, pos!.marketReferencePrice * 0.93);
      await flushAsync();

      expect(captured?.reason).toBe('smart_v3_mae_fast_fail');
      const rows = mockAppendFile.mock.calls
        .filter((call) => typeof call[0] === 'string' && call[0].includes('smart-v3-paper-trades.jsonl'))
        .map((call) => JSON.parse(String(call[1]).trim()))
        .filter((row) => row.positionId === pos!.positionId);
      expect(rows.at(-1)?.smartV3MaeFastFail).toBe(true);
      expect(rows.at(-1)?.extras?.smartV3MaeFastFail).toBe(true);
      expect(rows.at(-1)?.sellRetryUrgency ?? 'paper').toBe('paper');
    });

    it('smart-v3: 최근 참여 KOL buy 가 있으면 mae fast-fail 을 유예한다', async () => {
      mockedConfig.kolHunterSmartV3FreshWindowSec = 120;
      stubFeed.setInitialPrice(MINT_SMART, 0.001);
      await handleKolSwap(buyTx('k1', 'S', MINT_SMART, 70_000));
      await handleKolSwap(buyTx('k2', 'A', MINT_SMART));
      ...
      pos!.troughPrice = pos!.marketReferencePrice;
      mockedConfig.kolHunterSmartV3MaeFastFailMinElapsedSec = 0;
      await handleKolSwap({ ...buyTx('k2', 'A', MINT_SMART, -2_000), solAmount: 0.04 });
      let captured: any = null;
      kolHunterEvents.once('paper_close', (evt) => { captured = evt; });
      __testTriggerTick(pos!.positionId, pos!.marketReferencePrice * 0.93);
      await flushAsync();
      ...
      expect(__testGetActive().some((p) => p.positionId === pos!.positionId)).toBe(true);
    });
    ...
    it('smart-v3: pre-T1 MFE가 있으면 hard cut 직전 1회 recovery hold 를 부여한다', async () => {
      ...
      expect(pos).toBeDefined();
      pos!.entryPriceTokenOnly = pos!.marketReferencePrice;
      pos!.peakPrice = pos!.marketReferencePrice * 1.12;
      pos!.troughPrice = pos!.marketReferencePrice;
      let captured: any = null;
      kolHunterEvents.once('paper_close', (evt) => { captured = evt; });
      __testTriggerTick(pos!.positionId, pos!.marketReferencePrice * 0.88);
      await flushAsync();

      expect(captured).toBeNull();
      expect(pos!.smartV3MaeRecoveryHold).toBe(true);
      expect(pos!.smartV3MaeRecoveryHoldReason).toBe('pre_t1_mfe_recovery_window');

      pos!.smartV3MaeRecoveryHoldUntilSec = Math.floor(Date.now() / 1000) - 1;
      kolHunterEvents.once('paper_close', (evt) => { captured = evt; });
      __testTriggerTick(pos!.positionId, pos!.marketReferencePrice * 0.88);
      await flushAsync();
      ...
      const rows = mockAppendFile.mock.calls
        ...
        .map((call) => JSON.parse(String(call[1]).trim()))
        .filter((row) => row.positionId === pos!.positionId);
      expect(rows.at(-1)?.smartV3MaeRecoveryHold).toBe(true);
      expect(rows.at(-1)?.extras?.smartV3MaeRecoveryHold).toBe(true);
    });
    ...
    it('smart-v3: T1 전 수익권 되밀림은 pre-T1 MFE band 로 기록한다', async () => {
      ...
      expect(captured?.reason).toBe('probe_flat_cut');
      const rows = mockAppendFile.mock.calls
        .filter((call) => typeof call[0] === 'string' && call[0].includes('smart-v3-paper-trades.jsonl'))
        .map((call) => JSON.parse(String(call[1]).trim()))
        .filter((row) => row.positionId === pos!.positionId);
      const row = rows.at(-1);
      expect(row?.smartV3PreT1MfeBand).toBe('20_30');
      expect(row?.smartV3PreT1ClosePct).toBeCloseTo(-0.02);
    ...
    it('capitulation-rebound: 급락 후 회복 확인이 쌓이면 paper-only rebound lane 으로 진입한다', async () => {
      mockedConfig.kolHunterCapitulationReboundEnabled = true;
      mockedConfig.kolHunterCapitulationReboundMinKolScore = 4.0;
      ...
      await flushAsync();
      stubFeed.emitTick(MINT_SMART, 0.00066);
      await flushAsync();

      const positions = __testGetActive();
      expect(positions).toHaveLength(1);
      expect(positions[0].armName).toBe('kol_hunter_capitulation_rebound_v1');
      expect(positions[0].parameterVersion).toBe('capitulation-rebound-v1.0.0');
      expect(positions[0].kolEntryReason).toBe('capitulation_rebound');
      expect(positions[0].t1MfeOverride).toBe(0.08);
      expect(positions[0].probeHardCutPctOverride).toBe(0.06);
    ...
    it('capitulation-rebound: 같은 가격 반복 tick 은 recovery confirmation 으로 중복 계산하지 않는다', async () => {
      ...
      expect(__testGetActive()).toHaveLength(1);
      expect(__testGetActive()[0].capitulationRecoveryConfirmations).toBe(2);
    });

    it('capitulation-rebound: trade markout 은 fast rebound horizon 을 사용한다', async () => {
      mockedConfig.kolHunterCapitulationReboundEnabled = true;
      mockedConfig.kolHunterCapitulationReboundMinKolScore = 4.0;
      mockedConfig.kolHunterSmartV3VelocityScoreThreshold = 99;
      mockedConfig.kolHunterSmartV3PullbackMinKolCount = 99;
      ...
      const anchorRows = mockAppendFile.mock.calls
        .filter((call) => typeof call[0] === 'string' && call[0].includes('trade-markout-anchors.jsonl'))
        .map((call) => JSON.parse(String(call[1]).trim()));
      expect(anchorRows[0].extras.armName).toBe('kol_hunter_capitulation_rebound_v1');
      expect(anchorRows[0].extras.markoutOffsetsSec).toEqual([15, 30, 60, 180, 300, 1800]);
    });

    it('capitulation-rebound: entry sell quote 실패도 전용 no-trade markout 으로 남긴다', async () => {
      mockedConfig.kolHunterCapitulationReboundEnabled = true;
      mockedConfig.kolHunterCapitulationReboundMinKolScore = 4.0;
      mockedConfig.kolHunterSmartV3VelocityScoreThreshold = 99;
      mockedConfig.kolHunterSmartV3PullbackMinKolCount = 99;
      ...
      try {
        ...
        const markers = mockAppendFile.mock.calls
          .filter((call) => typeof call[0] === 'string' && call[0].includes('missed-alpha.jsonl'))
          .map((call) => JSON.parse(String(call[1]).trim()))
          .filter((row) => row.rejectReason === 'capitulation_rebound_sell_quote_failed');
        expect(markers).toHaveLength(1);
        expect(markers[0].rejectReason).toBe('capitulation_rebound_sell_quote_failed');
        expect(markers[0].signalSource).toBe('kol_hunter_capitulation_rebound_v1');
        expect(markers[0].extras.noTradeReason).toBe('sell_quote_failed');
        expect(markers[0].extras.survivalFlags).toContain('NO_SELL_ROUTE');
        expect(markers[0].probe.offsetSec).toBe(0);
      } finally {
        mockedConfig.kolHunterRunSellQuoteProbe = false;
        mockedConfig.missedAlphaObserverEnabled = false;
    ...
    it('capitulation-rebound: 무반응이면 빠르게 close 하고 전용 projection ledger 에 남긴다', async () => {
      mockedConfig.kolHunterCapitulationReboundEnabled = true;
      mockedConfig.kolHunterCapitulationReboundMinKolScore = 4.0;
      mockedConfig.kolHunterSmartV3VelocityScoreThreshold = 99;
      mockedConfig.kolHunterSmartV3PullbackMinKolCount = 99;
      ...
      const pos = __testGetActive()[0];
      pos.entryTimeSec = Math.floor(Date.now() / 1000) - 16;
      let captured: any = null;
      kolHunterEvents.once('paper_close', (evt) => { captured = evt; });
      __testTriggerTick(pos.positionId, pos.entryPrice * 1.001);
      await flushAsync();

      expect(captured?.reason).toBe('capitulation_no_reaction');
      const projectionRows = mockAppendFile.mock.calls
        .filter((call) => typeof call[0] === 'string' && call[0].includes('capitulation-rebound-paper-trades.jsonl'))
        .map((call) => JSON.parse(String(call[1]).trim()));
      expect(projectionRows).toHaveLength(1);
      expect(projectionRows[0].entryReason).toBe('capitulation_rebound');
      expect(projectionRows[0].capitulationTelemetry.drawdownFromPeakPct).toBeGreaterThan(0.35);
      expect(projectionRows[0].extras.capitulationRecoveryConfirmations).toBe(2);
    });
    ...
    it('rotation-underfill: 1 KOL buy 뒤 KOL 기준가보다 낮은 quote 는 paper arm 으로 진입한다', async () => {
      ...
      expect(positions[0].rotationMonetizableEdge?.pass).toBe(true);
      expect(positions[0].rotationMonetizableEdge?.costRatio).toBeLessThan(0.06);
      expect(positions[0].rotationMonetizableEdge?.walletDragRatio).toBeGreaterThan(0.06);
      expect(positions[0].survivalFlags).toContain('ROTATION_EDGE_SHADOW_PASS');
    ...
    it('rotation-underfill: close ledger 에 openedAt/entryReason/extras/MFE alias 를 남긴다', async () => {
      ...
      expect(row.rotationMonetizableEdge.pass).toBe(true);
    ...
    it('rotation-v1: DOA 이후 낮은 MFE + -3% MAE 는 mae fast-fail 로 닫는다', async () => {
      mockedConfig.kolHunterRotationV1Enabled = true;
      ...
      let captured: any = null;
      kolHunterEvents.once('paper_close', (evt) => { captured = evt; });
      __testTriggerTick(pos.positionId, pos.entryPrice * 0.965);
      await flushAsync();

      expect(captured?.reason).toBe('rotation_mae_fast_fail');
      expect(__testGetActive()).toHaveLength(0);
      const closeRows = mockAppendFile.mock.calls
        .filter((call) => typeof call[0] === 'string' && call[0].includes('rotation-v1-paper-trades.jsonl'))
        .map((call) => JSON.parse(String(call[1]).trim()))
        .filter((row) => row.positionId === pos.positionId);
      expect(closeRows.at(-1)?.rotationMaeFastFail).toBe(true);
      expect(closeRows.at(-1)?.extras?.rotationMaeFastFail).toBe(true);
    });

    it('rotation-v1: T1 전이라도 충분한 MFE가 있으면 mae fast-fail 로 닫지 않는다', async () => {
      mockedConfig.kolHunterRotationV1Enabled = true;
      mockedConfig.kolHunterRotationV1DoaWindowSec = 1;
      stubFeed.setInitialPrice(MINT_ROTATION, 0.001);
      await handleKolSwap({ ...buyTx('dv', 'A', MINT_ROTATION, 3_000), solAmount: 0.95 });
      ...
      const pos = __testGetActive()[0];
      pos.entryTimeSec -= 6;
      __testTriggerTick(pos.positionId, pos.entryPrice * 1.02);
      __testTriggerTick(pos.positionId, pos.entryPrice * 0.965);

      expect(__testGetActive().map((active) => active.positionId)).toContain(pos.positionId);
    });

    it('rotation-v1: mae fast-fail 비활성화 시 동일 조건에서도 닫지 않는다', async () => {
      mockedConfig.kolHunterRotationV1Enabled = true;
    ...
    it('Phase C: rotation family price kill 은 smart-v3 tail retain 을 상속하지 않는다', async () => {
      mockedConfig.kolHunterTailRetainEnabled = true;
      mockedConfig.kolHunterRotationV1Enabled = true;
      mockedConfig.kolHunterSmartV3VelocityScoreThreshold = 99;
      mockedConfig.kolHunterRotationUnderfillDoaMaxMaePct = 0.50;
      mockedConfig.kolHunterRotationMaeFastFailEnabled = false;
      try {
        stubFeed.setInitialPrice(MINT_ROTATION, 0.001);
        await handleKolSwap(buyTxWithFill('decu', 'A', MINT_ROTATION, 0.001, 0.25, 1_000));
        ...
        const parent = __testGetActive().find((p) => p.armName === 'rotation_underfill_v1');
        expect(parent).toBeDefined();
        __testTriggerTick(parent!.positionId, parent!.entryPrice * 0.90);
        await flushAsync();

        const positions = __testGetActive();
        expect(positions.find((p) => p.isTailPosition === true)).toBeUndefined();
        expect(positions.find((p) => p.parentPositionId === parent!.positionId)).toBeUndefined();
      } finally {
        mockedConfig.kolHunterTailRetainEnabled = false;
        mockedConfig.kolHunterRotationUnderfillDoaMaxMaePct = 0.02;
        mockedConfig.kolHunterRotationMaeFastFailEnabled = true;
  ...
  describe('smart-v3 trigger → live canary wiring (2026-04-28)', () => {
    ...
    function buildLiveCtx(opts: {
      ...
      return { ctx, executeBuy, executeSell, getTokenBalance, getBalance, insertTrade, closeTrade, sendTradeOpen, sendTradeClose };
    }
    ...
    it('smart-v3 pullback live-disabled 는 live 차단 후 paper fallback 으로 비교군을 남긴다', async () => {
      ...
      expect(policyRecordsWithFlag('SMART_V3_STRATEGY_NO_PAPER_FALLBACK')).toHaveLength(0);
    ...
    it('smart-v3 live arm 미선택이면 live 차단 후 main paper fallback 으로 비교군을 남긴다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({ priceFeed: stubFeed as unknown as never, ctx });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
    ...
    it('smart-v3 live main 도 fast-fail/runner-relaxed paper shadow arms 를 병렬 생성한다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({ priceFeed: stubFeed as unknown as never, ctx });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      ...
      const fastFail = positions.find((p) => p.armName === 'smart_v3_fast_fail');
      const runner = positions.find((p) => p.armName === 'smart_v3_runner_relaxed');
      expect(live?.armName).toBe('kol_hunter_smart_v3');
      expect(fastFail?.isLive).toBe(false);
      expect(fastFail?.isShadowArm).toBe(true);
      expect(fastFail?.parentPositionId).toBe(live?.positionId);
      expect(fastFail?.probeHardCutPctOverride).toBe(0.06);
      expect(runner?.isLive).toBe(false);
      expect(runner?.isShadowArm).toBe(true);
      expect(runner?.parentPositionId).toBe(live?.positionId);
      expect(runner?.t1TrailPctOverride).toBeGreaterThan(live?.t1TrailPctOverride ?? 0);
    });
    ...
    it('smart-v3 live strict quality override: exit liquidity unknown 은 live 차단 후 paper fallback 으로 비교군을 남긴다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({
        priceFeed: stubFeed as unknown as never,
        ctx,
      ...
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      mockedConfig.kolHunterSmartV3LiveBlockExitLiquidityUnknown = true;
      mockedConfig.kolHunterSmartV3LiveBlockTokenQualityUnknown = true;
    ...
    it('smart-v3 unknown-only quality 는 smart_v3_clean live 로 유지한다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({
        priceFeed: stubFeed as unknown as never,
        ctx,
      ...
      const equivalence = liveEquivalenceRecords().find((row) => row.liveAttempted === true);
      expect(equivalence?.armName).toBe('kol_hunter_smart_v3');
      expect(equivalence?.parameterVersion).toBe('smart-v3.0.0');
      expect(equivalence?.candidateId).toContain(':kol_hunter_smart_v3:');
    });

    it('smart-v3 live strict quality: unclean holder concentration 은 live 차단 후 paper fallback 으로 남긴다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({
        priceFeed: stubFeed as unknown as never,
        ctx,
    ...
    it('smart-v3 quality unknown micro arm: holder/unclean hard-risk 는 allowlist 가 있어도 live 차단 후 paper fallback 으로 남긴다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({
        priceFeed: stubFeed as unknown as never,
        ctx,
    ...
    it('smart-v3 fast canary arm: medium holder-risk 도 smart_v3_clean 없이 암묵 live 진입하지 않는다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({
        priceFeed: stubFeed as unknown as never,
        ctx,
        securityClient: buildSecurityClient({ top10HolderPct: 0.55 }) as never,
      });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
    ...
    it('smart-v3 fast-fail live arm: paper/live 괴리 flag 는 허용하고 구조적 위험은 차단한다', () => {
      mockedConfig.kolHunterLiveCanaryArms = ['smart_v3_fast_fail_live_v1'];

      expect(__testCanRouteSmartV3FastFailLive([
        'SMART_V3_LIVE_DISABLED',
        'SMART_V3_LIVE_QUALITY_FALLBACK',
        'SMART_V3_QUALITY_UNCLEAN_TOKEN:top10_65pct',
      ])).toBe(true);

      expect(__testCanRouteSmartV3FastFailLive([
        'SMART_V3_ENTRY_ADVANTAGE_ADVERSE',
        'SMART_V3_KOL_FILL_ADVERSE_0.6483',
      ])).toBe(true);
      ...
      expect(__testCanRouteSmartV3FastFailLive([
        'SMART_V3_ENTRY_ADVANTAGE_ADVERSE',
        'SMART_V3_KOL_FILL_ADVERSE_0.9000',
      ])).toBe(false);
    ...
    it('smart-v3 fast-fail live arm: top10 65pct fallback 후보를 별도 live canary 로 라우팅한다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({
        priceFeed: stubFeed as unknown as never,
        ctx,
      ...
      expect(live?.parameterVersion).toBe('smart-v3-fast-fail-live-v1.0.0');
      expect(live?.t1MfeOverride).toBe(mockedConfig.kolHunterT1Mfe);
      expect(live?.t1TrailPctOverride).toBe(mockedConfig.kolHunterSmartV3T1TrailVelocity);
      expect(live?.probeFlatTimeoutSec).toBe(mockedConfig.kolHunterSmartV3ProbeTimeoutVelocitySec);
      expect(live?.survivalFlags).toEqual(expect.arrayContaining([
      ...
      const equivalence = liveEquivalenceRecords().find((row) => row.liveAttempted === true);
      expect(equivalence?.armName).toBe('smart_v3_fast_fail_live_v1');
      expect(equivalence?.parameterVersion).toBe('smart-v3-fast-fail-live-v1.0.0');
    ...
    it('smart-v3 fast-fail live arm: arm threshold 초과 집중은 paper fallback 으로 유지한다', async () => {
      ...
      __testInit({
        priceFeed: stubFeed as unknown as never,
        ctx,
        securityClient: buildSecurityClient({ top10HolderPct: 0.75 }) as never,
      });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      mockedConfig.kolHunterLiveCanaryArms = ['smart_v3_fast_fail_live_v1'];
      mockedConfig.kolHunterSmartV3FastFailLiveMaxTop10HolderPct = 0.70;
      ...
      expect(equivalence?.paperWouldEnter).toBe(true);
      expect(equivalence?.liveBlockFlags).toContain('SMART_V3_QUALITY_UNCLEAN_TOKEN:top10_75pct');
    });
    ...
    it('smart-v3 pre-entry sell 후 fresh re-buy 부족이면 live 차단 후 paper fallback 으로 남긴다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({ priceFeed: stubFeed as unknown as never, ctx });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      ...
      stubFeed.setInitialPrice(MINT_SMART, 0.001);
      await handleKolSwap(sellTx('pain', 'S', MINT_SMART, 0.20, 2_000));
      await handleKolSwap(buyTx('pain', 'S', MINT_SMART, 1_000));
      await handleKolSwap(buyTx('ghost', 'A', MINT_SMART));
      await flushAsync();
    ...
    it('smart-v3 KOL fill 대비 불리한 가격이면 live 차단 후 paper fallback 으로 남긴다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({ priceFeed: stubFeed as unknown as never, ctx });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      ...
      await handleKolSwap(buyTxWithFill('ghost', 'A', MINT_SMART, 0.00100, 0.10));
      await flushAsync();
    ...
    it('smart-v3 combo posterior-lite: 반복 손실 조합은 live 차단 후 paper fallback 으로 남긴다', async () => {
      mockedConfig.kolHunterPaperOnly = true;
      mockedConfig.kolHunterLiveCanaryEnabled = false;
      mockedConfig.kolHunterSmartV3ComboDecayMinCloses = 2;
      const mintA = `${MINT_SMART.slice(0, -1)}A`;
      const mintB = `${MINT_SMART.slice(0, -1)}B`;
      const mintC = `${MINT_SMART.slice(0, -1)}C`;
      for (const mint of [mintA, mintB]) {
        stubFeed.setInitialPrice(mint, 0.001);
        await handleKolSwap(buyTx('pain', 'S', mint));
        await handleKolSwap(buyTx('ghost', 'A', mint));
        await flushAsync();
        if (mint === mintA) {
          await handleKolSwap(buyTx('latecomer', 'A', mint));
          await flushAsync();
          const reinforced = __testGetActive().find((p) => p.tokenMint === mint)!;
          expect(reinforced.participatingKols.map((k) => k.id)).toContain('latecomer');
          expect(reinforced.smartV3EntryComboKey).toBe('ghost+pain');
        }
        const pos = __testGetActive().find((p) => p.tokenMint === mint)!;
        __testTriggerTick(pos.positionId, pos.entryPrice * 0.88);
        await flushAsync();
      }
      ...
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      stubFeed.setInitialPrice(mintC, 0.001);
      await handleKolSwap(buyTx('pain', 'S', mintC));
      await handleKolSwap(buyTx('ghost', 'A', mintC));
      await flushAsync();

      expect(executeBuy).not.toHaveBeenCalled();
      expect(insertTrade).not.toHaveBeenCalled();
      const blockedPaper = __testGetActive().find((p) => p.tokenMint === mintC);
      expect(blockedPaper?.isLive).toBeFalsy();
      const equivalence = liveEquivalenceRecords().find((row) =>
    ...
    it('smart-v3 combo posterior-lite: live 손실 1건은 같은 entry combo 를 live 차단 후 paper fallback 으로 남긴다', async () => {
      const mintB = `${MINT_SMART.slice(0, -1)}M`;
      mockedConfig.kolHunterSmartV3ComboDecayMinCloses = 2;
      __testRecordSmartV3ComboClose(['pain', 'ghost'], -0.01, 'live');

      const second = buildLiveCtx();
      __testInit({
        priceFeed: stubFeed as unknown as never,
        ctx: second.ctx,
        securityClient: buildSecurityClient() as never,
      });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      stubFeed.setInitialPrice(mintB, 0.001);
      await handleKolSwap(buyTx('pain', 'S', mintB));
      await handleKolSwap(buyTx('ghost', 'A', mintB));
      await flushAsync();

      expect(second.executeBuy).not.toHaveBeenCalled();
      const blockedPaper = __testGetActive().find((p) => p.tokenMint === mintB);
      expect(blockedPaper?.isLive).toBeFalsy();
      const equivalence = liveEquivalenceRecords().find((row) =>
    ...
    it('dev wallet blacklist 는 ownerAddress 만 매칭되어도 live 차단 후 paper fallback 으로 남긴다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
    ...
    it('rotation-chase-topup live canary on: canonical rotation live off 여도 chase arm 만 executor 진입한다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({ priceFeed: stubFeed as unknown as never, ctx });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      ...
      expect(live?.parameterVersion).toBe('rotation-chase-topup-v1.0.0');
      expect(live?.rotationAnchorKols).toEqual(['decu']);
      expect(live?.survivalFlags).toEqual(expect.arrayContaining([
    ...
    it('rotation-chase-topup live canary: MAE fast-fail 은 live hard-cut sell path 를 탄다', async () => {
      ...
      mockedConfig.kolHunterRotationV1MinIndependentKol = 1;
      mockedConfig.kolHunterRotationV1DoaWindowSec = 1;
      mockedConfig.kolHunterRotationV1FreshBuyGraceSec = 0;
      mockedConfig.kolHunterRotationUnderfillT1Mfe = 0.20;
      mockedConfig.kolHunterRotationMaeFastFailMaxMfePct = 0.10;
      mockedConfig.kolHunterRotationChaseTopupLiveCanaryEnabled = true;
    ...
    it('rotation-underfill live canary: security exit-liquidity unknown 이라도 sized sell route 가 있으면 live 검증으로 진입한다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      mockedConfig.kolHunterRunSellQuoteProbe = true;
      const probeSpy = jest.spyOn(sellQuoteProbeModule, 'evaluateSellQuoteProbe').mockResolvedValue({
        approved: true,
      ...
      try {
        ...
        expect(live?.armName).toBe('rotation_underfill_v1');
        expect(live?.profileArm).toBe('rotation_underfill_exit_flow_v1');
        expect(live?.entrySecurityEvidence).toMatchObject({
          securityClientPresent: true,
          tokenSecurityKnown: true,
          exitLiquidityKnown: false,
        });
        expect(live?.entrySellQuoteEvidence).toMatchObject({
          probeEnabled: true,
          approved: true,
          routeFound: true,
          observedOutSol: 0.019,
        ...
        expect(live?.survivalFlags).toEqual(expect.arrayContaining([
          ...
          'ROTATION_UNDERFILL_PRELIVE_SELL_ROUTE_OK',
    ...
    it('rotation-underfill live canary: sized sell route 가 없으면 live 전 paper fallback 으로 남긴다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      mockedConfig.kolHunterRunSellQuoteProbe = true;
      const probeSpy = jest.spyOn(sellQuoteProbeModule, 'evaluateSellQuoteProbe').mockResolvedValue({
        approved: false,
      ...
      try {
        ...
        expect(equivalenceRows.at(-1)).toEqual(expect.objectContaining({
          ...
          preExecutionRouteFound: false,
        }));
        expect(equivalenceRows.at(-1)?.liveBlockFlags).toEqual(expect.arrayContaining([
          'ROTATION_UNDERFILL_LIVE_EXIT_ROUTE_UNKNOWN',
          'ROTATION_UNDERFILL_ROUTE_BUCKET_SELL_QUOTE_NO_ROUTE',
        ]));
      } finally {
        mockedConfig.kolHunterRunSellQuoteProbe = false;
        probeSpy.mockRestore();
    ...
    it('rotation-underfill live canary: 같은 KOL live 연속손실은 paper fallback 으로만 관측한다', async () => {
      ...
      mockedConfig.kolHunterRotationLiveKolDecayLossRatio = 1;
      mockedConfig.kolHunterRotationLiveKolDecayCooldownMs = 7_200_000;
      __testRecordRotationLiveKolClose(['decu'], -0.012);
      __testRecordRotationLiveKolClose(['decu'], -0.009);
      ...
      expect(paper?.survivalFlags).toEqual(expect.arrayContaining([
        ...
        'ROTATION_LIVE_KOL_DECAY_KOL_DECU',
        'ROTATION_LIVE_KOL_DECAY_LOSSES_2_OF_2',
      ]));
      const equivalenceRows = mockAppendFile.mock.calls
        .filter((call) => typeof call[0] === 'string' && call[0].includes('kol-live-equivalence.jsonl'))
        .map((call) => JSON.parse(String(call[1]).trim()));
      ...
      expect(String(equivalenceRows.at(-1)?.liveBlockReason ?? '')).toContain('rotation_live_kol_decay:decu');
    });

    it('rotation-underfill live canary: restart hydrate 된 live 손실도 KOL decay 에 반영한다', async () => {
      const { ctx, executeBuy, insertTrade } = buildLiveCtx();
      __testInit({ priceFeed: stubFeed as unknown as never, ctx });
      mockedConfig.kolHunterPaperOnly = false;
      mockedConfig.kolHunterLiveCanaryEnabled = true;
      ...
      const summary = hydrateRotationLiveKolDecayFromCloseRecords([
        {
          positionId: 'rotation-loss-1',
          isLive: true,
          armName: 'rotation_underfill_v1',
          profileArm: 'rotation_underfill_exit_flow_v1',
          netSol: null,
          closedAt: new Date(nowMs - 65_000).toISOString(),
          kols: [{ id: 'decu' }],
        },
        {
          positionId: 'rotation-loss-1',
          ...
          profileArm: 'rotation_underfill_exit_flow_v1',
          netSol: -0.010,
          closedAt: new Date(nowMs - 60_000).toISOString(),
          kols: [{ id: 'decu' }],
        },
        {
          positionId: 'rotation-loss-2',
          isLive: true,
          armName: 'rotation_underfill_v1',
          profileArm: 'rotation_underfill_exit_flow_v1',
          netSol: -0.012,
          closedAt: new Date(nowMs - 30_000).toISOString(),
          extras: { rotationAnchorKols: ['decu'] },
        },
        {
          positionId: 'rotation-loss-2-tail',
          isLive: true,
          parentPositionId: 'rotation-loss-2',
          armName: 'rotation_underfill_v1',
          profileArm: 'rotation_underfill_exit_flow_v1',
          netSol: -0.050,
          closedAt: new Date(nowMs - 20_000).toISOString(),
          kols: [{ id: 'decu' }],
        },
        {
          positionId: 'rotation-expired',
          isLive: true,
          armName: 'rotation_underfill_v1',
          netSol: -0.010,
          closedAt: new Date(nowMs - 8_000_000).toISOString(),
          kols: [{ id: 'yenni' }],
        },
      ], nowMs);

      expect(summary).toEqual({ loaded: 5, hydrated: 2, skippedExpired: 1 });
      ...
      expect(insertTrade).not.toHaveBeenCalled();
      const paper = __testGetActive().find((p) => p.isLive !== true);
      expect(paper?.survivalFlags).toContain('ROTATION_LIVE_KOL_DECAY');
      expect(paper?.survivalFlags).toContain('ROTATION_LIVE_KOL_DECAY_KOL_DECU');
    });
    ...
    it('live fresh reference guard: pre-buy reference drift 가 크면 live 대신 paper fallback', async () => {
      ...
      expect(positions[0].smartV3LiveBlockReason).toBe('live_fresh_reference_reject');
      expect(positions[0].smartV3LiveBlockFlags).toEqual(expect.arrayContaining([
        'LIVE_FRESH_REFERENCE_REJECT',
        expect.stringMatching(/^LIVE_FRESH_REFERENCE_DRIFT_PCT=/),
      ]));
    ...
    it('live canary: wallet healthy 여도 single-KOL smart-v3 는 strategy reject 로 남긴다', async () => {
      ...
      expect(equivalence?.paperWouldEnter).toBe(true);
      expect(equivalence?.liveWouldEnter).toBe(false);
      expect(equivalence?.liveBlockFlags).toContain('LIVE_MIN_KOL');
    });
    ...
    it('yellow-zone: smart-v3 single-KOL live 는 paper fallback 으로 비교군을 남긴다', async () => {
      const { ctx, executeBuy } = buildLiveCtx();
      const { setWalletStopGuardStateForTests } = require('../src/risk/walletStopGuard');
      setWalletStopGuardStateForTests(false, 'yellow-zone-test', 0.80);
      __testInit({ priceFeed: stubFeed as unknown as never, ctx, securityClient: buildSecurityClient() as never });
