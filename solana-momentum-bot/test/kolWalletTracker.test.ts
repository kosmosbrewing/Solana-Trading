...
describe('KolWalletTracker.syncActiveSet (B-fix)', () => {
  const ADDR_A = '7khwnu615pERQyPVD1Q85FHVcaovXBqL89wQrscDRqxa';
  const ADDR_B = 'C4a3sC6gPjH2B3ZVTipGPpPEiRvCswG19vqajdWc9VX';
  const ADDR_C = 'ACzrcfMv2k1uoyxqgk2uWK65qZvG3JRZH4GiBCMQwUXk';
...
describe('KolWalletTracker.shadowTrackInactive (Option A)', () => {
  ...
  const ACTIVE_ADDR = '7khwnu615pERQyPVD1Q85FHVcaovXBqL89wQrscDRqxa';
  const INACTIVE_ADDR = 'C4a3sC6gPjH2B3ZVTipGPpPEiRvCswG19vqajdWc9VX';
